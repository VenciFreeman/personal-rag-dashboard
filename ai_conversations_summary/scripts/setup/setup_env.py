...
from ai_conversations_summary.runtime_paths import HF_CACHE_DIR, LOCAL_MODELS_DIR, VECTOR_DB_DIR
...
def _resolve_layout(project_root: Path) -> tuple[Path, Path, Path, Path, Path]:
    ...
    local_models_root = LOCAL_MODELS_DIR
    hf_cache_root = HF_CACHE_DIR
    vector_db_root = VECTOR_DB_DIR
