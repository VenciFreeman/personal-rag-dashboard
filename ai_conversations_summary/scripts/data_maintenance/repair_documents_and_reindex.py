...
from ai_conversations_summary.runtime_paths import DOCUMENTS_DIR, SUMMARIZE_DIR
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--root", default=str(WORKSPACE_ROOT / "ai_conversations_summary"), help="ai_conversations_summary root directory")
