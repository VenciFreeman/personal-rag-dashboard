...
Usage:
    python scripts/ontology_review.py                       # review all domains
    python scripts/ontology_review.py --domain music        # filter by domain
    python scripts/ontology_review.py --domain music --list # list pending without reviewing
    python scripts/ontology_review.py --stats               # show proposal stats
